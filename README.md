# Второе домашнее задание - продолжение знакомства с командами git
## Создание и редактирование файлов с помощью команды 'cat', работа с командами 'find' и 'grep' 
---
...
mkdir directory && echo "save my tekst" >> random_file.txt


36. Команда в одну строку. Переместить в любую одну папку текстовые файлы у которых в содержимом
есть слово “sec” - 
grep -lr sec * | xargs mv -t directory/

37. Команда в одну строку. Скопировать в любую одну папку текстовые файлы
у которых в содержимом есть слово “sec” - 
